package com.one.north.repository;

import com.one.north.OneangularApp;
import com.one.north.config.Constants;
import com.one.north.config.audit.AuditEventConverter;
import com.one.north.domain.PersistentAuditEvent;
...
import static com.one.north.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
